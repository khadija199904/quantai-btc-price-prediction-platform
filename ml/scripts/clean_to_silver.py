...
def clean_to_silver():
    ...
    window_ma5 = Window.orderBy("open_time_ts").rowsBetween(-4, 0)
    window_ma10 = Window.orderBy("open_time_ts").rowsBetween(-9, 0)
    ...
    df_cleaned = df.dropna(subset=["target_close", "returns", "MA_5", "MA_10"])
    print("Nulls dropped.")
